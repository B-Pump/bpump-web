...
const SkeletonOne = () => {
    ...
    return (
        <motion.div
            initial="initial"
            whileHover="animate"
            className="flex size-full min-h-[6rem] flex-1 flex-col space-y-2"
        >
            <motion.div
                variants={variants}
...
const SkeletonThree = () => {
    ...
    return (
        <motion.div
            ...
            className="flex size-full min-h-[6rem] flex-1 flex-col space-y-2 rounded-lg"
            style={{
...
const SkeletonFour = () => {
    ...
    return (
        <motion.div
            ...
            animate="animate"
            whileHover="hover"
            className="flex size-full min-h-[6rem] flex-1 flex-row space-x-2"
        >
            <motion.div
                variants={first}

        ...
        <div className={cn("sticky top-80", className)}>
            ...
            <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center absolute">
                <button
                    ...
                    className="font-bold bg-black dark:bg-white text-white dark:text-black rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-xs w-fit mx-auto"
                >
                    En savoir plus
                </button>
            </div>

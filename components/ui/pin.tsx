...
export function AnimatedPin({ title, description, link }: { title: string; description: string; link: string }) {
    return (
        <PinContainer title={link} href={link}>
            <div className="flex size-[20rem] basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 ">
